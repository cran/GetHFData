...
Lets assume you want high frequency trading data for options in a given date  (2015-11-26). This file could be downloaded from the ftp using function `ghfd_download_file`, but it is already available locally in the package.
...
In `tickers.out` one can find the symbols available in the file and also the number of trades for each. Now, lets take the 3 most traded instruments in that day and check the result of the import process:
